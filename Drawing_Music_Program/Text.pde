...
String textBox = "Hover over the colour for a few seconds until they become darker to activate them, then proceed to click the tools to change the colour. Deactivate a colour by hovering over it before selecting another colour.";
//
void textSetup()
{
